...
def main() -> None:
    ...
    print(
        f"  {'Test Acc (before training)':35s}  {scratch['pre_test_acc']*100:>8.1f}%  {transfer['pre_test_acc']*100:>8.1f}%"
    )
    print(
        f"  {'Test Acc (after training)':35s}  {scratch['test_acc']*100:>8.1f}%  {transfer['test_acc']*100:>8.1f}%"
    )
    print(
        f"  {'Final Val Accuracy':35s}  {scratch['val_acc'][-1]*100:>8.1f}%  {transfer['val_acc'][-1]*100:>8.1f}%"
    )
    print(
        f"  {'Training Time (s)':35s}  {scratch['elapsed']:>9.1f}  {transfer['elapsed']:>9.1f}"
    )
