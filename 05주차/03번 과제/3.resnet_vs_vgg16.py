...
def main() -> None:
    ...
    print(f"  {'Test Acc (before training)':35s}  {r['pre_test_acc']*100:>8.1f}%  {v['pre_test_acc']*100:>8.1f}%")
    print(f"  {'Test Acc (after training)':35s}  {r['test_acc']*100:>8.1f}%  {v['test_acc']*100:>8.1f}%")
    print(f"  {'Final Val Accuracy':35s}  {r['val_acc'][-1]*100:>8.1f}%  {v['val_acc'][-1]*100:>8.1f}%")
